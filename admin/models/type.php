...
*/
 defined('_JEXEC') or die('Restricted access');
/**
 * ContainercodeModelType 
 * @author Daniel Eliasson Stilero Webdesign
 */
 
 
class ContainercodeModelType  extends ContainercodeModel { 

	
	
	protected $_default_filter = 'a.type_code';   
 ...
 */
	...
	*/
	...
	protected function _buildContentWhere() 
	{
		...
		if ($search) {
			$this->_query->where('LOWER(a.type_code) LIKE ' . $this->_db->Quote('%' . $search . '%'));			
		}		
		if ($filter_state) {
			if ($filter_state == 'P') {
