...
/**
 * ContainercodeType Controller
 *
 * @package    Containercode
 * @subpackage Controllers
 */
class ContainercodeControllerType extends ContainercodeController
{
	/**
	 * Constructor
	 */
	protected $_viewname = 'type'; 
	...
	public function publish() 
	{
		...
		$this->setRedirect('index.php?option=com_containercode&view=type');
	}
