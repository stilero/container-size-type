	 	...
	 	<div class="col width-70 fltlft">
		  <fieldset class="adminform">
			<legend><?php echo JText::_( 'Details' ); ?></legend>
				...
				<?php echo $this->form->getLabel('main_charact'); ?>
				
					
				<div class="clr"></div>
					
				<?php echo $this->form->getInput('main_charact');  ?>
					
				<?php echo $this->form->getLabel('type_group_id'); ?>
				
				<?php echo $this->form->getInput('type_group_id');  ?>
