<?php
/**
 * @version $Id: #component#.php 96 2011-08-11 06:59:32Z michel $ 1 2012-03-16Z Stilero Webdesign $
...
$config 	=& JComponentHelper::getParams( 'com_containercode' );

$controller = JRequest::getWord('view', 'firstchar');
...
$classname    = 'ContainercodeController'.$controller;
