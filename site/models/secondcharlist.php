...
class ContainercodeModelSecondcharlist extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
			...
			$this->setState('secondcharlist.id', $id);			
	}

	protected function getStoreId($id = '')
	{
		// Compile the store id.
		$id	.= ':'.$this->getState('secondcharlist.id');
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__containercode_sizecode_secondchar as a');	
