...
class ContainercodeModelTypegrouplist extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
			...
			$this->setState('typegrouplist.id', $id);			
	}

	protected function getStoreId($id = '')
	{
		// Compile the store id.
		$id	.= ':'.$this->getState('typegrouplist.id');
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__containercode_sizecode_typegroup as a');	
