...
/**
 * ContainercodeModelSecondchar
 * @author $Author$
 */
 
 
class ContainercodeModelSecondchar  extends JModelItem { 

	
	
	protected $context = 'com_containercode.secondchar';   
	/**
	...
	public function populateState()
	{
		...
		$this->setState('secondchar.id', $id);
	...
	protected function getStoreId($id = '')
	{
		...
		$id	.= ':'.$this->getState('secondchar.id');
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Secondchar', 'Table');
