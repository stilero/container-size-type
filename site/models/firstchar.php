...
class ContainercodeModelFirstchar  extends JModelItem { 

	
	
	protected $context = 'com_containercode.firstchar';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Firstchar', 'Table');
