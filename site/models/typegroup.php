...
class ContainercodeModelTypegroup  extends JModelItem { 

	
	
	protected $context = 'com_containercode.typegroup';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Typegroup', 'Table');
